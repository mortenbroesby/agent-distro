...
| --- | --- | --- | --- |
| 0 | Active | [Reliable installation and diagnostics](../active/00-reliable-installation-and-diagnostics.md) | [Issue-report handoff](../active/01-opt-in-issue-reporting.md) |
