...
| --- | --- | --- | --- |
| 0 | Active | [Reliable runtime and observable installation](../active/09-reliable-runtime-and-observability.md) | Packed CLI runs on Node 20, 22, 24, and 26 on macOS and Windows |
